...
\newpage
\section{DOA estimation using a microphone array}
...
\newpage
\input{8x2_MicArray}
\input{8x1_Measurement_1_Anechoic_chamber}
\newpage
\input{6x1_Conclusion}
\include{90_Appendix}
\input{2x1_Environmental_Sound_Propagation}
\input{2_Models}
